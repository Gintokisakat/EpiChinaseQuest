    ...
    >
      ...
      <motion.div
        ...
        className={`
          ...
          ${isLocked ? 'bg-gray-700/60 cursor-default ring-1 ring-gray-600' : 'cursor-pointer'}
          ${!isLocked && status === 'unlocked' ? 'bg-amber-500 ring-2 ring-amber-400/50' : ''}
          ${!isLocked && status === 'completed' ? 'bg-emerald-500 ring-2 ring-emerald-400/50' : ''}
